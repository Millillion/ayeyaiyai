...
var obj = {
  *method([w = counter(), x = counter(), y = counter(), z = counter()]) {
    __assertSameValue(w, null);
    __assertSameValue(x, 0);
    __assertSameValue(y, false);
    __assertSameValue(z, '');
    __assertSameValue(initCount, 0);
    callCount = callCount + 1;
  }
};

obj.method([null, 0, false, '']).next();
__assertSameValue(callCount, 1, 'generator method invoked exactly once');
