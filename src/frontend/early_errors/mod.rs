...
pub(crate) use syntax::{
    BindingRestrictions, collect_module_declared_names, collect_pattern_binding_names,
    collect_var_decl_bound_names, ensure_module_lexical_names_are_unique, validate_class_syntax,
    validate_class_syntax_with_restrictions, validate_declaration_syntax,
    validate_declaration_syntax_with_restrictions, validate_expression_syntax,
    validate_expression_syntax_with_restrictions, validate_function_syntax,
    validate_function_syntax_with_restrictions, validate_script_body_early_errors,
