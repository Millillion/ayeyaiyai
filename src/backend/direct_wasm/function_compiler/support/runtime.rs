...
pub(in crate::backend::direct_wasm) use builtin_catalog::{
    bound_function_prototype_call_builtin_name, builtin_constructor_prototype_kind,
    builtin_function_runtime_entries, builtin_function_runtime_value, builtin_member_function_name,
    builtin_member_number_value, builtin_prototype_function_name, builtin_prototype_number_value,
