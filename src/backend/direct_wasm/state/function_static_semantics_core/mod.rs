...
pub(in crate::backend::direct_wasm) struct FunctionStaticSemanticsState {
    ...
    pub(in crate::backend::direct_wasm) materializing_expression_keys: RefCell<HashMap<usize, u64>>,
...
impl FunctionStaticSemanticsState {
    pub(in crate::backend::direct_wasm) fn from_prepared_bindings(
        ...
        Self {
            ...
            materializing_expression_keys: RefCell::new(HashMap::new()),
            local_lexical_initialized_locals,
            immutable_local_bindings,
            eval_lexical_initialized_locals: HashMap::new(),
            capture_slot_source_bindings: HashMap::new(),
            capture_slot_initial_source_bindings: HashMap::new(),
