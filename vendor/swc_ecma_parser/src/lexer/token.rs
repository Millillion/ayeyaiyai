...
impl Token {
    pub const fn is_reserved(self, ctx: Context) -> bool {
        match self {
            ...
            // `await` is reserved in the Module goal, async contexts, and
            // class static blocks - not in strict-mode scripts (ECMA-262
            // sec-keywords-and-reserved-words). Mirrors Context::is_reserved_word.
            Token::Await => {
