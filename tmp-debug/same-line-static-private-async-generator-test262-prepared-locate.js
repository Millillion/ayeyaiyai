...
console.log("before hasown assert");
__assert(
  !Object.prototype.hasOwnProperty.call(c, "m"),
  "m doesn't appear as an own property on the C instance"
);
console.log("after hasown assert");
__assertSameValue(c.m, C.prototype.m);
console.log("after samevalue method");
...
c.m().next().then(function(v) {
  console.log("in outer then");
  console.log("before v value assert");
  console.log(v.value);
  console.log(v.done);
  ...
  console.log("before assertions promise");
