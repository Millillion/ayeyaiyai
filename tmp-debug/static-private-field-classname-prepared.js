...
c.m().next().then(function(v) {
  ...
  function assertions() {
    ...
    __assertSameValue(C.$(1), 1);
    __assertSameValue(C._(1), 1);
    __assertSameValue(C.o(1), 1);
    __assertSameValue(C.℘(1), 1);      // DO NOT CHANGE THE NAME OF THIS FIELD
    __assertSameValue(C.ZW_‌_NJ(1), 1); // DO NOT CHANGE THE NAME OF THIS FIELD
    __assertSameValue(C.ZW_‍_J(1), 1);  // DO NOT CHANGE THE NAME OF THIS FIELD
