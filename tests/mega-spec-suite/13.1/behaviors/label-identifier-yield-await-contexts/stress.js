// behavior: label-identifier-yield-await-contexts
// expected: pass
// goal: script
// size: stress
...
var score = 0;
var labelCount = 0;
yield: for (var labelI = 0; labelI < 3; labelI = labelI + 1) { labelCount = labelCount + 1; if (labelI === 1) { break yield; } }
await: { labelCount = labelCount + 10; break await; }
score = score + labelCount;
if (labelCount !== 12) { throw "label"; }
var v0 = 0;
score = score + v0;
if (v0 !== 0) { throw "v0"; }
